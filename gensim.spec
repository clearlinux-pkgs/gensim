...
Source0  : https://files.pythonhosted.org/packages/95/5f/e1de63570c0c74faeaaed614e57ecf01dab441b449eabc312c5eb876b24b/gensim-4.1.1.tar.gz
...
%prep
%setup -q -n gensim-4.1.1
cd %{_builddir}/gensim-4.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631663808
...
cp %{_builddir}/gensim-4.1.1/COPYING %{buildroot}/usr/share/package-licenses/gensim/01a6b4bf79aca9b556822601186afab86e8c4fbf
