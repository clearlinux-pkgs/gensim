...
Version  : 3.8.2
Release  : 46
URL      : https://files.pythonhosted.org/packages/8a/cd/c3181a9bf69cf2929bcf2ead1f1d7779b0ed375aecff157c48b2ff417367/gensim-3.8.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/cd/c3181a9bf69cf2929bcf2ead1f1d7779b0ed375aecff157c48b2ff417367/gensim-3.8.2.tar.gz
...
%prep
%setup -q -n gensim-3.8.2
cd %{_builddir}/gensim-3.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586809768
...
cp %{_builddir}/gensim-3.8.2/COPYING %{buildroot}/usr/share/package-licenses/gensim/01a6b4bf79aca9b556822601186afab86e8c4fbf
